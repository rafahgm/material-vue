 ...
 */
export default function ComponentImportPlugin(options: MaterialVueOptions & { prefix: NonNullable<MaterialVueOptions['prefix']> }, meta: UnpluginContextMeta) {
  ...
  const pluginOptions = defu(options.components, <ComponentsOptions>{
    ...
    exclude: [
      /[\\/]node_modules[\\/](?!\.pnpm|material-vue|@compodium\/examples)/,
      /[\\/]\.git[\\/]/,
      /[\\/]\.nuxt[\\/]/
    ],
    resolvers: [
