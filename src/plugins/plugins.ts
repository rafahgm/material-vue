 ...
 */
export default function PluginsPlugin(options: MaterialVueOptions) {
  ...
  return {
    name: 'material-vue:plugins',
    enforce: 'pre',
    resolveId(id) {
      if (id === 'material-vue/vue-plugin') {
        return 'virtual:material-vue-plugins'
      }
    },
    transform(code, id) {
    ...
    loadInclude: id => id === 'virtual:material-vue-plugins',
    load() {
      return `
