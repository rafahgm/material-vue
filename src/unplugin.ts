...
export interface MaterialVueOptions extends Omit<ModuleOptions, 'fonts' | 'colorMode'> {
...
export const MaterialVuePlugin = createUnplugin<MaterialVueOptions | undefined>((_options = {}, meta) => {
